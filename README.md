...
- [**Git Builder**](Docker/git-builder/README.md): Configurable Git webhook builds, deployment scripts and managed services for Node.js and Java projects, with Apprise HTTP notifications; AMD64/ARM64
...
| [Git Builder](https://github.com/funnyzak/docker-release/tree/main/Docker/git-builder/README.md) | [![Docker Tag](https://img.shields.io/docker/v/funnyzak/git-builder?sort=semver&style=flat-square)](https://hub.docker.com/r/funnyzak/git-builder) | [![Docker Image Size](https://img.shields.io/docker/image-size/funnyzak/git-builder)](https://hub.docker.com/r/funnyzak/git-builder) | [![Docker Pulls](https://img.shields.io/docker/pulls/funnyzak/git-builder.svg?style=flat-square)](https://hub.docker.com/r/funnyzak/git-builder) |
